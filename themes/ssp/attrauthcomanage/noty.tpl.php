    ...
    <div class="noty-description">
        ...
        foreach($this->data['noty']['description'] as $dict_key => $placeholders) {
            if(!empty($placeholders)) {
                print $this->t('{themeegi:attrauthcomanage_noty:' . $dict_key . '}', $placeholders);
            } else {
                print $this->t('{themeegi:attrauthcomanage_noty:' . $dict_key . '}');
            }
        }
        ?>
    </div>
...
<form style="display: inline;"
    ...
    <button type="submit"
            ...
            name="no"
            id="nobutton">
        <?= htmlspecialchars($this->t('{themeegi:attrauthcomanage_noty:no}')) ?>
    </button>
</form>
...
<script type="application/javascript">
    ...
    function form_ajax(frm_ob) {
        ...
        jqxhr.done((data, textStatus, xhr) => {
            ...
            $('.invite-expire').html('<?= htmlspecialchars($this->t('{themeegi:attrauthcomanage_noty:invitation_restored}')); ?>');
